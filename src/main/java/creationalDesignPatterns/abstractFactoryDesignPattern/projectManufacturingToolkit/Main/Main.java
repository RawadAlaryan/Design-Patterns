...
public class Main {
	public static void main(String[] args) {
        ...
        CPU intelCPU = factory.createCPU();								System.out.println(intelCPU);
        Memory intelMemory = factory.createMemory();			System.out.println(intelMemory);
        
        System.out.println("\nManufacturing Products for AMD Architecture Platform:");
        factory = AbstractFactory.getFactory(AbstractFactory.Architecture.AMD);
        CPU amdCPU = factory.createCPU();								System.out.println(amdCPU);
        Memory amdMemory = factory.createMemory();		System.out.println(amdMemory);
	}
}
