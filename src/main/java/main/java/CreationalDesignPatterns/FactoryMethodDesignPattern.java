...
Factory Method Design Pattern can be implemented in many techniques:
	Implementation with Abstract Creator.	Strict Technique.		package:		FactoryImplementationWithAbstractCreator 	
	Implementation with Concrete Creator.										package:		FactoryImplementationWithConcreteCreator
	Implementation with Static Method Creator.							package:		FactoryImplementationWithStaticMethodCreator
